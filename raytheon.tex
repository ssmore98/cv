...
\quote{
    \begin{itemize}
        \item 20+ years of experience as software developer in Linux environment using C/C++
        ...
        \item Strong algorithms and data structures background specializing
            in performance optimization and parallel algorithms
...
\cvitem{Parallel Computing}{Software development on parallel computers like Intel Paragon,
IBM SP2 (distributed memory architecture) and SGI Origin (Shared memory architecture). Developed multi-threaded
I/O library \cite{c1}. Used MPI and MPI-IO libraries to develop high performance I/O software for large
parallel and distributed systems \cite{passion}\cite{c3}\cite{c4}\cite{c6}.}
\cvitem{Performance Optimization}{
	Performed performance analysis  and designed high performance algorithms for I/O subsystems in
	parallel computers as well as multi-processor enterprise storage systems. Deep knowledge of
	performance benchmarking and software development for benchmarking tools. Skilled at analysis
	and visual representation of performance data using software like gnuplot, Microsoft Excel and
	python modules like matplotlib and numpy.
}
\cvitem{Storage System Firmware}{New ideas were proposed, implemented and evaluated to improve various parts of 
                          ...
                          \begin{itemize}
                              ...
                              \item A new algorithm was designed to decide which copy of the data
					  ...
					  \cvitem{}{
                          ...
                          \begin{itemize}
                              ...
                              \item The existing data pre-fetching algorithm was enhanced for the cases where
                                  workloads contain short bursts of contiguous data accesses. (U.S. patent 6,721,870)
...
\cvitem{Simulation Software}{
                          \begin{itemize}
                              \item {\em Cache Simulator} This software simulated the behavior of the 
