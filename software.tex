...
\quote{
    \begin{itemize}
        ...
        \item Hands-on problem solving skills in different areas
...
\cvitem{Parallel Computing} {Worked on shared and distributed memory parallel computers like
...
\cvitem{Storage System Firmware}{New ideas were proposed, implemented and evaluated to improve various parts of 
                          ...
                          BSD-derived RTOS and tool-chain. The algorithms and data structures used were chosen
